...
const branches = [
  { name: "العجوزه وليس لنا فروع اخري بالعجوزه", location: "https://maps.app.goo.gl/MKWJvoWvB1nLtnA2A" },
...
const products = [
  ...
  { name: "كيزر طازة", category: "مخبوزات", image: "/images/kaizer.jpg" },
...
export default function Home() {
  return (
    <main dir="rtl" className="min-h-screen overflow-hidden bg-[#120807] text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-[#c9a86a]/30 bg-black/75 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <nav className="hidden gap-6 font-bold md:flex">
            ...
            <a href="#doctor">الدكتور ماركت</a>
          </nav>

          <a
            href={`https://wa.me/${whatsapp}`}
            target="_blank"
            className="rounded-full bg-green-600 px-5 py-3 font-black text-white shadow-xl transition hover:scale-105"
          >
            اطلب واتساب
          </a>
        </div>
        ...
        <div className="relative z-10 mx-auto flex min-h-[90vh] max-w-7xl items-center px-4">
          <div className="max-w-3xl rounded-[2rem] border border-[#c9a86a]/40 bg-black/45 p-8 shadow-2xl backdrop-blur-md">
            <Image
              ...
              width={220}
              height={220}
              className="mb-6 h-44 w-44 animate-pulse rounded-full bg-[#fff4e4] object-contain p-3 shadow-[0_0_40px_rgba(201,168,106,.7)]"
            />

            <p className="mb-4 inline-block rounded-full bg-[#c96b2c] px-5 py-2 font-black">
              Rigosa ع الأصل دور
            </p>

            <h1 className="text-5xl font-black text-[#ffd0a3] md:text-7xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                ...
                target="_blank"
                className="rounded-full bg-green-600 px-8 py-4 text-lg font-black shadow-xl transition hover:-translate-y-1 hover:scale-105"
              >
                اطلب الآن واتساب
              </a>
              ...
              <a
                href={`tel:${hotline}`}
                className="rounded-full bg-[#c9a86a] px-8 py-4 text-lg font-black text-black shadow-xl transition hover:-translate-y-1 hover:scale-105"
              >
                الخط الساخن {hotline}
              </a>
            </div>
            ...
            <article key={product.name} className="group overflow-hidden rounded-[2rem] bg-white text-[#24160f] shadow-2xl transition hover:-translate-y-3">
              ...
              <div className="p-6">
                ...
                <a
                  ...
                  target="_blank"
                  className="mt-5 block rounded-2xl bg-[#c96b2c] py-3 text-center font-black text-white"
                >
                  اطلب المنتج
                </a>
              </div>
      ...
      <section id="branches" className="bg-white px-4 py-16 text-[#24160f]">
        ...
        <div className="mx-auto grid max-w-7xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {branches.map((branch) => (
            <a
              ...
              target="_blank"
              className="rounded-3xl bg-[#fbefe4] p-6 text-center text-xl font-black shadow-lg transition hover:-translate-y-2 hover:bg-[#6f4e8b] hover:text-white"
            >
              📍 {branch.name}
        ...
        <div className="mx-auto mt-10 max-w-4xl rounded-3xl border border-red-300 bg-red-50 p-6 text-center text-xl font-black text-red-700">
          تنويه هام: ليس لنا فروع أخرى بالعجوزة سوى الفرع المذكور فقط.
        </div>
      </section>
      ...
      <section id="doctor" className="mx-auto max-w-7xl px-4 py-16">
        <div className="rounded-[2rem] border border-[#c9a86a]/40 bg-gradient-to-br from-[#321226] to-[#160807] p-7 shadow-2xl">
          <h2 className="text-center text-4xl font-black text-[#ffd0a3]">
            الدكتور ماركت
          </h2>

          <p className="mx-auto mt-4 max-w-3xl text-center text-lg leading-9 text-white/80">
            بجوار طيبة من الفينو للجاتوه فرع العجوزة يوجد ماركت تابع لنا اسمه
  ...
  <div className="grid gap-6 md:grid-cols-3">
    ...
    />
        ...
        <Image
          ...
          width={190}
          height={190}
          className="mx-auto mb-6 h-40 w-40 rounded-full bg-[#fff4e4] object-contain p-3 shadow-[0_0_50px_rgba(201,168,106,.8)]"
        />
      ...
      <a
        href={`https://wa.me/${whatsapp}`}
        target="_blank"
        className="fixed bottom-5 left-5 z-50 rounded-full bg-green-600 px-6 py-4 font-black text-white shadow-2xl transition hover:scale-110"
      >
        واتساب
      </a>
